<template>
  <section class="flex flex-col gap-7 text-center items-center justify-center h-screen w-full">
    <h1 class="text-8xl text-white font-bold">
      <span class="text-red-500 mr-16">></span>Fernando Rodríguez<span class="text-red-500">_</span>
    </h1>
