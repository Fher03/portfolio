...
const technologies: Record<"frontend" | "backend" | "devOps", Technology[]> = {
  frontend: [
    {
      name: "VueJS",
      icon: "fontisto:vuejs",
...
<template>
  ...
  >
    <div class="w-full flex flex-col gap-2">
      ...
      <p class="text-gray-500 text-xl">// Herramientas y tecnologias que domino.</p>
    </div>
